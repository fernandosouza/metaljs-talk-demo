...
'use strict';(function(){(function(){this.CLOSURE_NO_DEPS=true;this.goog=this.goog||{}; // Copyright 2006 The Closure Library Authors. All Rights Reserved.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
// You may obtain a copy of the License at
 ...
 */goog.typeOf=function(value){var s=typeof value==='undefined'?'undefined':babelHelpers.typeof(value);if(s=='object'){if(value){ // Check these first, so we can avoid calling Object.prototype.toString if
// possible.
//
 ...
 * @param {?} val Variable to test.
 * @return {boolean} Whether variable is an object.
 */goog.isObject=function(val){var type=typeof val==='undefined'?'undefined':babelHelpers.typeof(val);return type=='object'&&val!=null||type=='function'; // return Object(val) === val also works, but is slower, especially if val is
// not an object.
}; /**
...
if(typeof key!='string'){throw Error('Map literal\'s key expression must evaluate to string'+' (encountered type "'+(typeof key==='undefined'?'undefined':babelHelpers.typeof(key))+'").');}return key;}; /**
...
/**
   ...
   */soy.esc.$$escapeHtmlHelper=function(v){return goog.string.htmlEscape(String(v));}; // END GENERATED CODE
goog.loadModule(function(){goog.module('soy');return soy;});goog.loadModule(function(){goog.module('soydata');return soydata;});goog.loadModule(function(){goog.module('soy.asserts');return soy;});})(); /* jshint ignore:end */goog.loadModule(function(){goog.module('incrementaldom');return IncrementalDOM;});}).call(window);}).call(this);
"use strict";
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ie_open('div', null, null, 'class', 'users-rating' + (opt_data.elementClasses ? ' ' + opt_data.elementClasses : ''));
      ie_open('h2');
      itext('Users List');
      ie_close('h2');
  ...
  var UsersRating = function (_Component) {
    babelHelpers.inherits(UsersRating, _Component);
  ...
  this.metal.UsersRating = templates;
  this.metalNamed.UsersRating = this.metalNamed.UsersRating || {};
  this.metalNamed.UsersRating.UsersRating = UsersRating;
  this.metalNamed.UsersRating.templates = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';

(function () {
	var templates = this.metal.UsersRating;
	var Component = this.metal.component;
	var Soy = this.metal.Soy;
	...
	this.metal.UsersRating = UsersRating;
}).call(this);
'use strict';
